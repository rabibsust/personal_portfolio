    ...
    <body>
      <div class="container">
        ...
        <div id="portfolio" class="scroll box">
          <div class="row">
            <div class="cos-xs-12">
              ...
              <h5>This will be the showcase for my projects. currently the development is ongoing</h5>
            </div>
            <div class="col-xs-12">
          ...
          <div class="row">
            ...
            <div class="cos-xs-12 col-sm-offest-1 col-sm-6 col-md-offest-1 col-md-6 col-lg-offest-1 col-lg-6">
              <form action="/contact.php" method="post" enctype="multipart/form-data">
                <div class="form-group cos-xs-12 col-sm-offest-1 col-sm-8 col-md-offest-1 col-md-8 col-lg-offest-1 col-lg-8">
                ...
                <div class="form-group cos-xs-12 col-sm-offest-1 col-sm-8 col-md-offest-1 col-md-8 col-lg-offest-1 col-lg-8">
                  <input type="text" class="form-control" id="msg" placeholder="Message" required>
                </div>
                <div class="form-group cos-xs-12 col-sm-offest-1 col-sm-8 col-md-offest-1 col-md-8 col-lg-offest-1 col-lg-8">
        ...
        <div class="footer text-center">
          <h3>
            Copyright &copy Ahmad Jamaly Rabib.
            2016
          </h3>
          <br/><br/>
        </div>
